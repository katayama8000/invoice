<template>
  ...
  >
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="save flex">
        <div class="left">
          <button type="button" @click="closeInvoice" class="red p-2 m-2">
            Cancel
          </button>
        </div>
        <div class="right flex">
          ...
          <button
            ...
            class="purple p-2 m-2"
          >
            Create Invoice
          </button>
          <button v-if="editInvoice" type="sumbit" class="purple p-2 m-2">
            Update Invoice
          </button>
        </div>
      </div>
