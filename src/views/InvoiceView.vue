  ...
  <div v-if="currentInvoice" class="invoice-view container">
    ...
    <div class="header flex">
      ...
      <div class="right flex">
        <button @click="toggleEditInvoice" class="dark-purple p-2 m-2">Edit</button>
        <button @click="deleteInvoice(currentInvoice.docId)" class="red p-2 m-2">Delete</button>
        <button @click="updateStatusToPaid(currentInvoice.docId)" v-if="currentInvoice.invoicePending" class="green p-2 m-2">
          Mark as Paid
        </button>
        <button
